...
var jbImagesDialog = {
	...
	inProgress : function() {
		...
		this.timeoutStore = window.setTimeout(function(){
			document.getElementById("upload_additional_info").innerHTML = 'Загрузка заняла больше времени чем обычно.' + '<br />' + 'Вероятно возникла ошибка.' + '<br /><a href="#" onClick="jbImagesDialog.showIframe()">' + 'Посмотреть вывод скрипта' + '</a>';
